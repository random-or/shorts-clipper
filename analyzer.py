...
def find_best_segment(transcript_text):
    ...
    prompt = (
        ...
        "Your task: Identify the single highest-energy, most viral-worthy 30-to-45 second hook suitable for Instagram Reels. "
        "Focus on sections with high engagement potential, clear emotional peaks, or self-contained interesting stories. "
        "Evaluate the transcript context and choose the most engaging framing strategy from these options: 'crop_center', 'crop_left', 'crop_right', 'split_screen'. "
        "Return ONLY the start timestamp, end timestamp, and the framing strategy in raw, comma-separated format (e.g., 580.0,615.0,crop_center). "
...
if __name__ == "__main__":
    ...
    if not os.environ.get("GEMINI_API_KEY"):
        ...
        test_transcript = "[10.0s - 15.0s] Hello world. [60.0s - 100.0s] This is a viral moment that everyone should see."
